...
/***/ "./frontend/ts/components/cookieNotice.component.ts":
/*!**********************************************************!*\
  !*** ./frontend/ts/components/cookieNotice.component.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    /* harmony export */   CookieNoticeComponent: () => (/* binding */ CookieNoticeComponent)
                    /* harmony export */
});
    /* harmony import */ var _utils_a11y_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/a11y.utils */ "./frontend/ts/utils/a11y.utils.ts");
    ...
    /* harmony import */ var wicg_inert__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(wicg_inert__WEBPACK_IMPORTED_MODULE_1__);
                ...
                class CookieNoticeComponent {
                    constructor() {
                        this.consentCookie = "__cookie_consent";
                        this.blockedCookie = "__cookie_blocked";
                        this.cookiePreferencesObject = {
                            advertising: false,
                            analytics: false,
                        ...
                        if (shouldRun && cookieBanner) {
                            ...
                            _utils_a11y_utils__WEBPACK_IMPORTED_MODULE_0__.A11yUtils.keepFocus(cookieBanner);
                            cookieBanner.focus();
                            this.setSiteContainerInert();
                            this.triggerEvent("cookienotice-banner-opened");
                            setTimeout(() => {
                                if (window.getComputedStyle(cookieOverlay).display === "none" ||
                    ...
                    closeCookieNotice(cookieModal = null) {
                        const cookieBanner = document.getElementById("cookienotice-banner");
                        const cookieOverlay = document.getElementById("cookienotice-overlay");
                        cookieBanner.classList.add("hidden");
                    ...
                    setUserCookiePreferences(event) {
                        event.preventDefault();
                    ...
                    updateCheckbox(label, init = false) {
                        const checkboxvar = document.getElementById(label);
                        if ((checkboxvar.defaultChecked && !checkboxvar.checked) ||
                            !checkboxvar.checked) {
                    ...
                    setCookie(key, expireDays, value) {
                        const date = new Date();
                        if (expireDays) {
                    ...
                    renderCookieModal() {
                        ...
                        const cookieOverlay = document.getElementById("cookienotice-overlay");
                        cookieOverlay.classList.remove("hidden");
                        _utils_a11y_utils__WEBPACK_IMPORTED_MODULE_0__.A11yUtils.keepFocus(this.cookieModal);
                    ...
                    setSiteContainerInert(set = true) {
    ...
    /***/ "./frontend/ts/utils/a11y.utils.ts":
    /*!*****************************************!*\
      !*** ./frontend/ts/utils/a11y.utils.ts ***!
      \*****************************************/
    /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    /* harmony export */   A11yUtils: () => (/* binding */ A11yUtils)
                ...
                class A11yUtils {
                    constructor() { }
                    static keepFocus(context, focusFirst = false) {
                ...
                A11yUtils.tabbableElements = `a[href]:not(.disabled), area[href], input:not([disabled]),
    ...
    (() => {
        ...
        /*!*****************************!*\
          ...
          \*****************************/
        __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _components_cookieNotice_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/cookieNotice.component */ "./frontend/ts/components/cookieNotice.component.ts");


        new _components_cookieNotice_component__WEBPACK_IMPORTED_MODULE_0__.CookieNoticeComponent();
