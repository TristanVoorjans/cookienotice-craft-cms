...
namespace voorjans\cookienotice\variables;

use voorjans\cookienotice\assetbundles\cookienotice\CookieNoticeAsset;
use voorjans\cookienotice\assetbundles\cookienotice\CookieNoticeNoStyleAsset;
use Craft;
...
class CookieNoticeVariable
{
    private array $banner = [
        'template' => 'cookie-notice/_cookiebanner',
        'mode' => View::TEMPLATE_MODE_CP
    ];
    private Entry $cookiePolicy;
    private array $modal = [
        'template' => 'cookie-notice/_cookiemodal',
        'mode' => View::TEMPLATE_MODE_CP
    ];
    private string $overlay = 'cookie-notice/_cookieoverlay';
